...
import { BiDotsHorizontalRounded } from "../node_modules/react-icons/bi";
...
export default function Home({ coins }) {
  const [myCoins] = useState([...coins.slice(0, 25)]);
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.rightMain}>
          ...
          {/* Map though coins and for every coin make an Asset */}
          {myCoins.map((coin) => {
